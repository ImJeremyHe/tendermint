...
func TestBlockAddEvidence(t *testing.T) {
	...
	block := MakeBlock(h, txs, commit, evList, 0)
...
func TestBlockHash(t *testing.T) {
	...
	assert.Nil(t, MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, 0).Hash())
}

func TestBlockMakePartSet(t *testing.T) {
	assert.Nil(t, (*Block)(nil).MakePartSet(2))

	partSet := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, 0).MakePartSet(1024)
...
func TestBlockMakePartSetWithEvidence(t *testing.T) {
	...
	partSet := MakeBlock(h, []Tx{Tx("Hello World")}, commit, evList, 0).MakePartSet(512)
	assert.NotNil(t, partSet)
...
func TestBlockHashesTo(t *testing.T) {
	...
	block := MakeBlock(h, []Tx{Tx("Hello World")}, commit, evList, 0)
...
func TestBlockSize(t *testing.T) {
	size := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, 0).Size()
	if size <= 0 {
...
func TestBlockString(t *testing.T) {
	...
	block := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, 0)
...
func TestBlockProtoBuf(t *testing.T) {
	...
	b1 := MakeBlock(h, []Tx{Tx([]byte{1})}, &Commit{Signatures: []CommitSig{}}, []Evidence{}, 0)
	b1.ProposerAddress = tmrand.Bytes(crypto.AddressSize)

	b2 := MakeBlock(h, []Tx{Tx([]byte{1})}, c1, []Evidence{}, 0)
	...
	b3 := MakeBlock(h, []Tx{}, c1, []Evidence{}, 0)
