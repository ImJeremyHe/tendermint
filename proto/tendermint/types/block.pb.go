...
type Block struct {
	...
	EthBlockNo int64        `protobuf:"varint,5,opt,name=eth_block_no,json=ethBlockNo,proto3" json:"eth_block_no,omitempty"`
}
...
func (m *Block) GetEthBlockNo() int64 {
	if m != nil {
		return m.EthBlockNo
	}
	return 0
...
var fileDescriptor_70840e82f4357ab1 = []byte{
	...
	0x34, 0x81, 0x89, 0x8b, 0xd5, 0x09, 0x64, 0xad, 0x90, 0x19, 0x17, 0x5b, 0x46, 0x6a, 0x62, 0x4a,
	...
	0x83, 0xb8, 0x40, 0x8a, 0x21, 0x6c, 0x21, 0x05, 0x2e, 0x9e, 0xd4, 0x92, 0x8c, 0x78, 0x70, 0x50,
	0xc7, 0xe7, 0xe5, 0x4b, 0xb0, 0x2a, 0x30, 0x6a, 0x30, 0x07, 0x71, 0xa5, 0x96, 0x64, 0x80, 0x83,
	0xc1, 0x2f, 0xdf, 0x29, 0xf0, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92,
	0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0xcc,
	0xd3, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x91, 0x03, 0x16, 0xc1, 0x84,
	0x44, 0x0f, 0x7a, 0xa0, 0x27, 0xb1, 0x81, 0xc5, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xc2,
	0x4b, 0xe3, 0xe3, 0xf3, 0x01, 0x00, 0x00,
}
...
func (m *Block) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EthBlockNo != 0 {
		i = encodeVarintBlock(dAtA, i, uint64(m.EthBlockNo))
		i--
		dAtA[i] = 0x28
	}
	if m.LastCommit != nil {
...
func (m *Block) Size() (n int) {
	...
	if m.EthBlockNo != 0 {
		n += 1 + sovBlock(uint64(m.EthBlockNo))
	}
	return n
}
...
func (m *Block) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EthBlockNo", wireType)
			}
			m.EthBlockNo = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EthBlockNo |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
